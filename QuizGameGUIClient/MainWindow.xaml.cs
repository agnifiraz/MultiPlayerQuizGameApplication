...
namespace QuizGameGUIClient
{
    ...
    public partial class MainWindow : Window, ICallBack
    {
        ...
        //players join to the lobby so that the game can not started with minimum player.
        ...
        //checking if the minimum player are available to proceed or not
